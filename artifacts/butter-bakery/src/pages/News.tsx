        ...
        <AnimatePresence mode="wait">
          {featured && (
            ...
            >
              {/* Featured Article */}
              <div
                className="group grid grid-cols-1 md:grid-cols-2 gap-0 border border-border hover:border-primary/40 transition-colors duration-500 mb-10 md:mb-16 cursor-pointer overflow-hidden"
                onClick={() => setSelected(featured)}
              >
                <div className="overflow-hidden h-64 md:h-full min-h-[280px]">
                  <img
                    src={featured.image}
                ...
                <div className="p-7 md:p-12 flex flex-col justify-between bg-secondary/30 group-hover:bg-secondary/60 transition-colors duration-500">
                  <div>
                    ...
                    <h2 className={`font-serif text-2xl md:text-4xl text-foreground leading-snug mb-4 md:mb-6 ${isAr ? "leading-relaxed" : ""}`}>
