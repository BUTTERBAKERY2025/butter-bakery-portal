      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8">
            ...
            <FadeIn>
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-primary text-[0.6rem] uppercase tracking-[0.3em] mt-0.5">{f.cafe}</p>
                </div>
              </div>
          ...
          <div className="md:col-span-2">
            <FadeIn delay={0.1}>
              <h4 className="text-xs uppercase tracking-widest text-background/40 mb-6">{f.navigate}</h4>
          ...
          <div className="md:col-span-2">
            <FadeIn delay={0.15}>
              <h4 className="text-xs uppercase tracking-widest text-background/40 mb-6">{f.contact}</h4>
          ...
          <div className="md:col-span-3">
            <FadeIn delay={0.2}>
              ...
              <ul className="space-y-2 text-sm font-light text-background/60">
                {f.branchList.map((b) => <li key={b}>{b}</li>)}
                <li className="text-primary/70 text-xs italic pt-1">{f.seasonal}</li>
              </ul>
