export const translations = {
  ...
  ar: {
    ...
    mission: {
      ...
      sub: "من الحرفية المحلية إلى المعايير العالمية",
      p1: "منذ تأسيسها، ظلت مهمة بتر بيكري واحدة: إحضار المخبوزات الطازجة إلى حياتك اليومية. نخدم عملائنا بشغف، بهدف التوسع في الشرق الأوسط — بنفس المهمة والقيم.",
    ...
    footer: {
      ...
      navLinks: [
        ...
        { label: "الكاترينج والمناسبات", href: "#catering" },
